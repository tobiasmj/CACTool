...
/**
 * Utility class to build event patterns. Uses chaining to quickly build
 * patterns, e.g: <code>
 * <pre>
 ...
 * 	.getPattern();
 * </pre>
 * </code> If you want to reuse instances of this class, remember to call
 * <code>reset()</code>. This class is not thread-safe.
 * 
 * @author frza
 * 
 */
...
public class PatternBuilder {
	...
	public <T extends Comparable<T>> PatternBuilder add(String fieldName,
			PatternOperator operator, T... value) {
