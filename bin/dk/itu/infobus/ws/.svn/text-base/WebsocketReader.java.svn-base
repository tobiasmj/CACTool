...
/**
 * Asynchronous websocket reader. Each time a message is read, it is dispatched
 * to the WebsocketMessageHandler. If an exception occours, the
 * WebsocketMessageHandler will be notified and the reader closed.
 * 
 * @author frza
 * 
 */
