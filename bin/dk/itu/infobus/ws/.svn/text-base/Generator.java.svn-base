...
/**
 * Abstract class representing an event generator. After constructing a
 * generator, one can register it using a dk.itu.infobus.ws.EventBus instance.
 * 
 * @author frza
...
public abstract class Generator {
	 ...
	 *            the given name
	 * @param fields
	 *            the list of fields that this generators' events will contains
	 */
	...
	/**
	 * When this generator wants to publish a new event, call this method.
	 * 
	 * @param evt
	 */
	...
	/**
	 * Called when the server figures out that this generator has no associated
	 * listeners
	 * 
	 * @param evt
	 * @throws Exception
	 */
	protected abstract void onDeactivationRequest(Map<String, Object> evt)
			throws Exception;

	/**
	 * Called when the server figures out that this generator has some
	 * associated listeners
	 * 
	 * @param evt
	 * @throws Exception
	 */
	protected abstract void onActivationRequest(Map<String, Object> evt)
			throws Exception;
	...
	/**
	 * Called when the an unidentified event has been received for this
	 * generator.
	 * 
	 * @param evt
	 * @throws Exception
	 */
	protected abstract void onSystemEvent(Map<String, Object> evt)
			throws Exception;
}
